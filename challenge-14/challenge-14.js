(function(){;
    ...
    */
    ...
    numberObjects.lastIndexOf({number: 2}, 2) ? console.log('Existe um objeto {number: 2} em numberObjects!') : console.log('Não existe um objeto { number: 2} em numberObjects');
    // ?
    ...
    */
    ...
    if (Array.isArray (justMod20r3))
        return console.log(justMod20r3.toString());
})()